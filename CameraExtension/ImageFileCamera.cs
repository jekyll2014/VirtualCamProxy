    ...
    public class ImageFileCamera : ICamera, IDisposable
    {
        ...
        public void SetFile(List<string> paths)
        {
            ...
            if (_fileNames.Any())
            {
                ...
                CurrentFps = 1000f / Delay;
                _format = new FileInfo(file).Extension;
                CurrentFrameFormat = new FrameFormat(0,
                    0,
                    _format,
                    CurrentFps);
            }
        ...
        private bool SetNextFile(bool repeat)
        {
            ...
            CurrentFps = 1000f / Delay;
            _format = new FileInfo(_imageFile).Extension;
            CurrentFrameFormat = new FrameFormat(0,
                0,
                _format,
                CurrentFps);
        ...
        public async Task<Mat?> GrabFrame(CancellationToken token)
        {
            ...
            var image = Cv2.ImRead(_imageFile, ImreadModes.Color);
